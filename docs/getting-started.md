...
The [`examples/bionicle/`](../examples/bionicle/) directory contains real artifacts generated by running two of the chained workflows against a fictional scenario — LEGO relaunching Bionicle as a connected toy with a companion app. Use these to see what each skill produces before running it on your own data.

### sprint-to-stakeholders
| File | Skill | What it shows |
|---|---|---|
| [`sprint-review-sprint-7-brick-by-brick.md`](../examples/bionicle/sprint-review-sprint-7-brick-by-brick.md) | `sprint-review` | Themed work groups, metrics table, carry-overs, risks |
| [`release-notes-2025-05-09.md`](../examples/bionicle/release-notes-2025-05-09.md) | `write-release-notes` | Filtered to customer-visible changes, fan-friendly voice |
| [`stakeholder-update-2025-05-09.md`](../examples/bionicle/stakeholder-update-2025-05-09.md) | `write-stakeholder-update` | Status signal, OKR progress table, go/no-go decision request |

### strategy-to-roadmap
| File | Skill | What it shows |
|---|---|---|
| [`STRATEGY.md`](../examples/bionicle/STRATEGY.md) | `write-product-strategy` | Three pillars with research citations and assumption tracking |
| [`OKRs-Q2-Q3-2025.md`](../examples/bionicle/OKRs-Q2-Q3-2025.md) | `write-okrs` | Outcome KRs, committed vs stretch, week-1 baselines flagged |
| [`ROADMAP.md`](../examples/bionicle/ROADMAP.md) | `write-roadmap` | Now/Next/Later with explicit "not doing" section and open dependencies |
